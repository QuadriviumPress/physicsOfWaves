...
In this chapter, we discuss the wave equation, the starting point for some other treatments of waves. We will get it as a natural result of our general principles of space translation invariance and local interactions applied to continuous systems.
...
[Figure 6.1](#fig-6-1): A continuous string with one end free to oscillate in the transverse direction.
